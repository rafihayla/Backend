...
{
    public class DishSeeder(ApplicationDbContext context)
    {
        ...
        public void Seed()
        {
            ...
            {
                var dishes = new List<Entities.DishDto>
                {
                    new()
                    {
                        Id = Guid.NewGuid(),
                        ...
                        Vegetarian = true,
                        Rating = null,
                        Category = Entities.DishCategory.Pizza
                    },
                    new()
                    {
                        Id = Guid.NewGuid(),
                    ...
                    new()
                    {
                        ...
                        Vegetarian = false,
                        Rating = 5,
                        Category = Entities.DishCategory.Wok
                    },new()
                    {
                        Id = Guid.NewGuid(),
                        Name = "Wok болоньезе",
                    ...
                    new()
                    {
                        ...
                        Vegetarian = true,
                        Rating = null,
                        Category = Entities.DishCategory.Drink
                    },
                    new()
                    {
                        Id = Guid.NewGuid(),
                    ...
                    new()
                    {
                        ...
                        Vegetarian = false,
                        Rating = null,
                        Category = Entities.DishCategory.Soup
                    },
                    new()
                    {
                        Id = Guid.NewGuid(),
                        ...
                        Vegetarian = true,
                        Rating = null,
                        Category = Entities.DishCategory.Dessert
                    },new()
                    {
                        Id = Guid.NewGuid(),
